  ...
  return (
    <div >
      ...
      <div className='mb-5' style={{ fontSize: '20px' }}>
        <ButtonShowMoreWhite title='Чем отличаются паллетные перевозки от сборных грузов?'
        ...
        <ButtonShowMoreWhite title=' Буду ли я стоять в очереди на растаможевание в сборном контейнере?'
        ...
        <ButtonShowMoreWhite title='Обязательно ли предоставлять сертификат происхождения (Certificate of Origin)?'
        ...
        <ButtonShowMoreWhite title='В домашнем коносаменте по моему грузу указан объем, отличный от указанных в коммерческих документах (инвойсе/пакинге). Что делать?'
        ...
        <ButtonShowMoreWhite title='Что такое сборный груз?'
        ...
        <ButtonShowMoreWhite title='Как доставить сборный груз из Китая?'
        ...
        <ButtonShowMoreWhite title='Правила перевозки сборных грузов'
          ...
          ' />
        <ButtonShowMoreWhite title='Необходимая документация'
          ...
          ' />
        <ButtonShowMoreWhite title='Нормативы сборных грузов'
       ...
       ' />
        <ButtonShowMoreWhite title='Что такое процесс консолидации?'
        ...
        <ButtonShowMoreWhite title='Что такое склады консолидации?'
          ...
          ' />
        <ButtonShowMoreWhite title='Как рассчитать объем груза?'
        ...
        <ButtonShowMoreWhite title='Преимущества грузоперевозок сборных грузов ж/д транспортом'
          ...
          ' />
        <ButtonShowMoreWhite title='Недостатки перевозок сборных грузов ж/д транспортом'
        ...
        <ButtonShowMoreWhite title='Перечень товаров, которые не принимаются к перевозке в составе сборных грузов:'
